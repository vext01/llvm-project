...
static void codegen(const Config &Conf, TargetMachine *TM,
  ...
  // Turn on the .llvm_bb_addr_map section for yk to use for mapping.
  //
  // FIXME: Later, if we still use this, expose this functionality as a plugin
  // option and upstream the change.
